                        ...
                        {getAllProduct.map((item, index) => {
                            ...
                            return (
                                <tr key={id} className="text-pink-300">
                                    <td className="h-12 px-6 text-md border-t border-l first:border-l-0 border-pink-100">{index + 1}.</td>
                                    ...
                                    <td className="h-12 px-6 text-md border-t border-l first:border-l-0 border-pink-100">{date}</td>
